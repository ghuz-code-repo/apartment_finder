...
permissions_registry.register('finder.managers_receivables_view', 'Менеджеры: моя дебиторка', 'Просмотр своей дебиторки по сделкам', 'view')
...
PERMISSION_MAP = {
    ...
    'managers_receivables_view': 'finder.managers_receivables_view',
